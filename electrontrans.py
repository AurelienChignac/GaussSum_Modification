...
########################################################################################################################
#                                                                                                                      #
#                         CE PROGRAMME A ETE MODIFIE PAR AURELIEN CHIGNAC LE 27/06/2020                                #
#                                                                                                                      #
#                                           Detail des modifications :                                                 #
#                                 - création d'un fichier 'Spectres CD.txt'                                            #
#                                 - création d'un fichier 'Transitions.txt'                                            #
#      - implémentation du fichier 'Spectres CD.txt' avec les spectres CD (énergie, longueur d'onde et valeur de CD)   #
#      - implémentation du fichier 'Transitions.txt' avec les transitions (longueur d'onde, énergies et valeurs de R)  #
#                                                                                                                      #
########################################################################################################################
...
#######################################################
        ...
        # Write "Spectre CD.txt" containing info on the CD spectrum
        screen.write("Writing the spectrum to CDSpectrum.txt\n")
        outputfile1=open(os.path.join(gaussdir,"Spectre CD.txt"),"w")
        outputfile1.write("Energy (cm-1)\tWidth (nm)\tAbs\n")
